...
class VideoTest {
	...
	void shouldThrowExceptionWhenFrameCutGreaterThanDuration() {
		...
		// Act & Assert
		assertThrows(VideoException.class, () -> video.setDurationMinutes(new DurationMinutes(1)));
	}
	...
	void shouldReturnDefaultExtensionWhenNoExtension() {
		// Arrange
		Video video = new Video(new com.soat.fiap.videocore.worker.core.domain.vo.VideoName("video"), new File("video"),
				new DurationMinutes(10), VideoFixture.inputStream(),
