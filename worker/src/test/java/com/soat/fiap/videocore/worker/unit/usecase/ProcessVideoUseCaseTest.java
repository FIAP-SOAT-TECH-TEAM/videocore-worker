...
class ProcessVideoUseCaseTest {
	...
	void shouldProcessVideoSuccessfully() throws IOException {
		...
		PublishVideoStatusProcessUpdateUseCase publishUseCase = mock(PublishVideoStatusProcessUpdateUseCase.class);
	...
	void shouldThrowExceptionWhenVideoOrStreamIsNull() {
		// Arrange
		ProcessVideoUseCase useCase = new ProcessVideoUseCase(mock(PublishVideoStatusProcessUpdateUseCase.class),
