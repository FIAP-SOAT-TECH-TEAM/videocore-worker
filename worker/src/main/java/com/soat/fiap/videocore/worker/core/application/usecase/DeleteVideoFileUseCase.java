 ...
 * garantindo a liberação de espaço em disco e evitando acúmulo de arquivos
 * temporários.
 */
...
public class DeleteVideoFileUseCase {
	 ...
	 *
	 * @param video
	 *            objeto de domínio contendo o arquivo do vídeo a ser removido
	 * @throws ProcessVideoException
	 *             caso ocorra erro de I/O durante a exclusão do arquivo
	 */
	...
	public void deleteVideoFile(Video video) {
		try {
			...
			throw new ProcessVideoException("Erro ao excluir arquivo temporário do vídeo processado", e);
		}
	}
}
