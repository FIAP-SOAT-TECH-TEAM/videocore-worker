...
/**
 * Caso de uso responsável por obter a duração de um vídeo em minutos e
 * atualizar o objeto {@link Video} com essa informação.
 */
...
public class GetVideoDurationMinutesUseCase {
	...
	/**
	 * Recupera a duração do vídeo em minutos usando o {@link ProcessVideoGateway} e
	 * seta no objeto {@link Video}.
	 *
	 * @param video
	 *            objeto de vídeo a ser atualizado com a duração
	 * @throws ProcessVideoException
	 *             caso ocorra algum erro ao obter a duração
	 */
