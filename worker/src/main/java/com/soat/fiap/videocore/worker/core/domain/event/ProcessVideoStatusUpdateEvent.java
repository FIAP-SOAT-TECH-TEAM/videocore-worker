...
/**
 * Evento de domínio que representa a atualização do status de processamento de
 * um vídeo.
 *
 * @param videoName
 *            Nome do vídeo.
 ...
 */
public record ProcessVideoStatusUpdateEvent(String videoName, String userId, String requestId, String traceId,
