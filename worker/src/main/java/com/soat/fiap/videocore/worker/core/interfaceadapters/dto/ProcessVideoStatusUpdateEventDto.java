...
/**
 * DTO para transporte do evento de atualização do status de processamento do
 * vídeo entre camadas.
 *
 * @param videoName
 *            Nome do vídeo.
 ...
 */
public record ProcessVideoStatusUpdateEventDto(String videoName, String userId, String requestId, String traceId,
