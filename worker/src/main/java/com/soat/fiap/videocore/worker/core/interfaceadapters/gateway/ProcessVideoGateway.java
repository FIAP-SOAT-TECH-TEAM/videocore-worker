...
/**
 * Gateway responsável por delegar o processamento de vídeo à camada de
 * infraestrutura. Atua como intermediário entre a camada de aplicação e a fonte
 * de dados.
 */
...
public class ProcessVideoGateway {
	 ...
	 * @throws IOException
	 *             em caso de erro de escrita
	 */
	@WithSpan(name = "gateway.process.video")
	public void processVideo(File file, long currentTimestamp, ZipOutputStream zipOutputStream, String imageName)
			throws IOException {
