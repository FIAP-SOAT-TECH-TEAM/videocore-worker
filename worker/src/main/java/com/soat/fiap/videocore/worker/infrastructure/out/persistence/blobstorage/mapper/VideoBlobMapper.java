...
public interface VideoBlobMapper {
	 ...
	 *
	 * @param inputStream
	 *            stream do conteúdo do blob
	 * @param metadata
	 *            mapa de metadados associados ao blob
	 * @param blobName
	 *            nome completo do blob no container
	...
	@Mapping(target = "durationMinutes", ignore = true) @Mapping(target = "videoFile", ignore = true)
