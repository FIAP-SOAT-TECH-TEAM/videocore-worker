...
/**
 * Input utilizado para representar dados de acompanhamento do processamento de
 * vídeo.
 */
@Data
public class VideoProcessMetadataInput {
	...
	/**
	 * Percentual atual de conclusão do processamento do vídeo. Valor esperado entre
	 * 0.0 e 100.0.
	 */
