...
public interface ProcessVideoSource {
     ...
     * @throws IOException em caso de erro de processamento ou escrita
     */
    void processVideo(File file, long currentTimestamp, ZipOutputStream zipOutputStream, String imageName) throws IOException;
}