...
import com.soat.fiap.videocore.worker.infrastructure.common.azure.blobstorage.AzureBlobStorageProperties;
...
public class AzureBlobStorageRepository implements VideoDataSource {
    ...
    /**
     * Cria um ZipOutputStream a partir de um BlobOutputStream, construido com as informações de um vídeo
     */
    @Override
